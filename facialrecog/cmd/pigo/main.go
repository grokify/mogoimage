...
pigo -in _input.jpg -out output.jpg -cf cascade/facefinder -angle=0.8 -iou=0.01

go run main.go -in _input.jpg -out output.jpg -cf cascade/facefinder -angle=0.8 -iou=0.01
